...
public class LoadingPage {
    ...
    private void initialize() {
        ...
        logo.setIcon(new ImageIcon(LoadingPage.class.getResource("/images/NewLogo.png")));
    ...
    private void startProgressBar() {
    	    ...
    	    timer = new Timer(40, event -> {
    	        if (progressValue >= 100) {
    	            ...
    	            try {
    	           	 PercentageFont = Font.createFont(Font.TRUETYPE_FONT, new File("C:\\Users\\Admin\\eclipse-workspace\\MainSystemOOP\\src\\fonts\\ZenMaruGothic-Regular.ttf"));
    	    ...
    	    Font PawFont = null;
            try {
            	PawFont = Font.createFont(Font.TRUETYPE_FONT, new File("C:\\Users\\Admin\\eclipse-workspace\\MainSystemOOP\\src\\fonts\\ZenMaruGothic-Regular.ttf"));
                GraphicsEnvironment ge = GraphicsEnvironment.getLocalGraphicsEnvironment();
    	    ...
    	    pawLabel.setBounds(391, 440, 457, 27);
